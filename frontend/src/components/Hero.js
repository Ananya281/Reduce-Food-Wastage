...
const Hero = () => {
  ...
  return (
    <section className="relative bg-gradient-to-r from-green-100 via-white to-green-50 h-[75vh] flex items-center justify-center text-center px-6">
      ...
      {/* Optional light pattern overlay or illustration here */}
